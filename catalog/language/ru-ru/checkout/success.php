<?php
// Heading
$_['heading_title']        = 'Ваш заказ принят! Ждите звонка менеджера!';
...
$_['text_guest']           = '<p>Ваш заказ принят!</p><p>Если у Вас возникли вопросы или на ваш E-mail не пришло письмо с заказом, пожалуйста <a href="%s">свяжитесь с нами</a>.</p><p>Спасибо за покупки в нашем интернет-магазине!</p>';
