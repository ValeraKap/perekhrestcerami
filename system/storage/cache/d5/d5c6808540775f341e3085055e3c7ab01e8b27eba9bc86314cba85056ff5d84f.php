...
class __TwigTemplate_7188b3612d8d0c83c2bbee1a1d3eefd8dec8d9d95f37ba697c1c2e388af7580e extends Twig_Template
{
      ...
      <div class=\"caption\">
        ...
        <div class=\"button-group\">
          <a class=\"btn btn-read-more\" href=\"";
            ...
            echo $this->getAttribute($context["post"], "href", array());
            echo "\" ";
            if ((($this->getAttribute($this->getAttribute((isset($context["j3"]) ? $context["j3"] : null), "settings", array()), "getIn", array(0 => "PostListButtonDisplay", 1 => $context), "method") == "icon") && $this->getAttribute($this->getAttribute((isset($context["j3"]) ? $context["j3"] : null), "settings", array()), "getIn", array(0 => "PostListButtonTooltipStatus", 1 => $context), "method"))) {
                echo "  data-toggle=\"tooltip\" data-tooltip-class=\"";
                echo (((isset($context["module_id"]) ? $context["module_id"] : null)) ? ((("module-blog_posts-" . (isset($context["module_id"]) ? $context["module_id"] : null)) . " module-blog_posts-list")) : ("post-list"));
                echo " read-more-tooltip\" data-placement=\"";
                echo $this->getAttribute($this->getAttribute((isset($context["j3"]) ? $context["j3"] : null), "settings", array()), "getIn", array(0 => "PostListButtonTooltipPosition", 1 => $context), "method");
                echo "\" title=\"";
...
";
    ...
    {
        return array (  145 => 33,  131 => 32,  125 => 29,  118 => 27,  111 => 24,  105 => 22,  103 => 21,  99 => 20,  91 => 14,  69 => 12,  45 => 10,  43 => 9,  38 => 8,  32 => 6,  30 => 5,  23 => 2,  19 => 1,);
    }
}
/* {% for post in posts %}*/
