...
class __TwigTemplate_e3dfb83b94ce5bcb749ea15b11d17f835ee9e6740cc15dc6f7af3247f023e590 extends Twig_Template
{
...
/*       <td class="text-right"><button type="button" value="{{ history.extension_install_id }}" data-loading="{{ text_loading }}" data-toggle="tooltip" title="{{ button_uninstall }}" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>*/
/*     </tr>*/
/*     {% endfor %}*/
/*     {% else %}*/
/*     <tr>*/
