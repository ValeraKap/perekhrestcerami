...
class __TwigTemplate_3255252a15a58a9f1d90600e4e221b16668e94c978bd8742e53762973d4dd313 extends Twig_Template
{
                ...
                foreach ($context['_seq'] as $context["id"] => $context["extra_button"]) {
                  ...
                  ";
                    ...
                    if (($this->getAttribute($context["extra_button"], "action", array()) == "quickbuy")) {
                        echo "onclick=\"cart.add('";
                        echo $this->getAttribute($context["product"], "product_id", array());
                        echo "', \$(this).closest('.button-group').find('input[name=\\'quantity\\']').val(), true);\"";
                    }
                    // line 151
                    echo "                  ";
...
/*                   {% if extra_button.action == 'quickbuy' %}onclick="cart.add('{{ product.product_id }}', $(this).closest('.button-group').find('input[name=\'quantity\']').val(), true);"{% endif %}*/
