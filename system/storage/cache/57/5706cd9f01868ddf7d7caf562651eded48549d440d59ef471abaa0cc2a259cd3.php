...
class __TwigTemplate_89b818aabfe8e219baaee9fc0538e755a58a8d3b7af2977d635fc572fdd42d46 extends Twig_Template
{
...
<html dir=\"";
        ...
        echo "\" data-jv=\"";
        echo twig_constant("JOURNAL3_VERSION");
        echo "\" data-ov=\"";
...
/* {% endif %}*/
/* <!DOCTYPE html>*/
/* <html dir="{{ direction }}" lang="{{ lang }}" class="{{ j3.document.getClasses() | join(' ') }}" data-jv="{{ constant('JOURNAL3_VERSION') }}" data-ov="{{ constant('VERSION') }}">*/
/* <head typeof="og:website">*/
/* <meta charset="UTF-8" />*/
/* <meta name="viewport" content="width=device-width, initial-scale=1.0">*/
/* <meta http-equiv="X-UA-Compatible" content="IE=edge">*/
