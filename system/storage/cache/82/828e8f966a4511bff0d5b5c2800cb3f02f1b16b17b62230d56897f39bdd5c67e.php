...
class __TwigTemplate_1ba9b125107436cf09f2153a27ae73ae97f2782fe9e57654cd7cbd9b99640393 extends Twig_Template
{
  ...
  <div class=\"modal-dialog\">
    <div class=\"modal-content\">
      ...
      <div class=\"modal-body\">
        ...
        // line 25
        echo $this->getAttribute((isset($context["paths"]) ? $context["paths"] : null), 0, array(), "array");
...
\te.preventDefault();
\t
\t\$('#modal-security #button-path').html(\$(this).text() + ' <span class=\"caret\"></span>');
\t
...
\t\t\tif (json['error']) {
\t\t\t\t\$('#modal-security #collapse-automatic legend').after('<div class=\"alert alert-danger alert-dismissible\"><i class=\"fa fa-exclamation-circle\"></i> ' + json['error'] + ' <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button></div>');
\t\t\t}

\t\t\tif (json['success']) {
\t\t\t\t\$('#modal-security #collapse-automatic legend').after('<div class=\"alert alert-success alert-dismissible\"><i class=\"fa fa-check-circle\"></i> ' + json['success'] + ' <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button></div>');
\t\t\t}
\t\t},
...
//--></script>";
    ...
    {
        return array (  209 => 125,  202 => 121,  197 => 119,  193 => 118,  189 => 117,  156 => 87,  107 => 41,  100 => 37,  92 => 34,  87 => 32,  83 => 30,  72 => 28,  68 => 27,  63 => 25,  56 => 21,  48 => 16,  44 => 15,  38 => 12,  32 => 9,  26 => 6,  19 => 1,);
    }
}
...
/*               <div class="input-group">*/
/*                 <div class="input-group-btn dropdown">*/
/*                   <button type="button" id="button-path" data-toggle="dropdown" class="btn btn-default">{{ paths[0] }} <span class="caret"></span></button>*/
/*                   <ul class="dropdown-menu">*/
/*                     {% for path in paths %}*/
