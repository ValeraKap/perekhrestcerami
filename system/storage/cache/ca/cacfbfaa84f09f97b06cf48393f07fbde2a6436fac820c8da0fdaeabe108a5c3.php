...
class __TwigTemplate_483a36d4e153ccfa06a07d95728c2281065950dfdbc90932945c51ed02a18d4f extends Twig_Template
{
        ...
        ";
            ...
            ";
                ...
                if ($this->getAttribute($this->getAttribute((isset($context["j3"]) ? $context["j3"] : null), "settings", array()), "get", array(0 => "catalogCartStatus"), "method")) {
                    ...
                    echo $this->getAttribute($context["product"], "product_id", array());
                    echo "', \$(this).closest('.button-group').find('input[name=\\'quantity\\']').val());\" data-loading-text=\"<span class='btn-text'>";
                    echo (isset($context["button_cart"]) ? $context["button_cart"] : null);
